...
void UltraSonicSensor(){
  ...
  if(distance1 <= 15){
    Blynk.email("dhunganaganesh8@gmail.com", "Dustbin Alert", "Dustbin is nearly full!");
    Blynk.email("sparshbhattarai01@gmail.com", "Dustbin Alert", "Dustbin is nearly full!");
    Blynk.email("afuskett@gmail.com", "Dustbin Alert", "Dustbin is nearly full!");
    Blynk.email("promisedahal937@gmail.com", "Dustbin Alert", "Dustbin is nearly full!");
